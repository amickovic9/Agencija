...
@foreach ($photos as $photo)
    <div class="photo-container text-center">
        ...
        <div class="button-group mt-3">
            <a href="/admin/photo-delete/{{$photo['id']}}" class="btn btn-success" role="button">Obrisi</a>
            @if ($photo['is_allowed'])
            <a href="/admin/photo-hide/{{$photo['id']}}" class="btn btn-success" role="button">Sakrij</a>    
            @else 
